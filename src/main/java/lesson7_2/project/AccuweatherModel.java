...
private static final ObjectMapper objectMapper = new ObjectMapper();
    ...
    break;
     ...
     //TODO: сделать человекочитаемый вывод погоды. Выбрать параметры для вывода на свое усмотрение/для дз7
...
//accuweatherModel.getWeather("Moscow", NOW); //для первого случая|2...
//accuweatherModel.detectCityKey("Moscow"); //для второго случая|2
//accuweatherModel.getWeather("Moscow", NOW); //для третьего случая/4
